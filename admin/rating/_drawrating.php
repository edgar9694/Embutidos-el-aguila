...
$query=mysqli_query($rating_conn ,"SELECT total_votes, total_value, used_ips FROM rating WHERE id='$id'");
if (!$query)
  {
...
$query2=mysqli_query($rating_conn ,"SELECT used_ips FROM rating WHERE used_ips LIKE '%".$ip."%' AND id='".$id."' ");
if (!$query2)
  {
  echo("Error description: " . mysqli_error($rating_conn));
  }
